...
const FocusTaskExistForm = ({ onClose, OpenNext, TaskSelector}) => {
  return (
    <div className="padding-24 display displayColumn gap-24">
      ...
      <div className="display displayColumn gap-12">
        <button className="ExistingTaskSelector btnOutlineBorder borderRadius-16 padding-24 display gap-24 alignItemsC" onClick={() => {onClose(); TaskSelector()}}>
